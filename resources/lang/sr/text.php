...
return [
    ...
    'subtitle' => 'nova tehnologija',
    'catalog-cta' => 'Preuzmi katalog',
    'info' => 'Informacije',
...
ekonomije.',
    ...
    'product1-introduction-text' => 'MART FIRE COLLAR je obujmica napravljena od kućišta od nerđajućeg čelika sa pokretnim umetkom od materijala koji
ekspandira na temperaturi iznad 150 °C',
    ...
    'product1-bottom' => 'SMART FIRE COLLAR je pogodan za ugradnju na zidove (blok, cigla, gips), kao i na međuspratne konstrukcije.',
...
- Zaptivanje otvora kroz koje prodiru plastične i metalne cevi, odnosno kablovi',
    ...
    'product3-application-text' => 'SMART FIRE MASTIC je zaptivka koja zaustavlja prodiranje vatre u zidovima i podovima. Dizajnirana je da se koristi kao zaptivka oko snopova kablova, kablova koji su stacionirani u fleksibilnim cevima, gorivih i negorivih cevi, u svrhu izolacije i sprečavanja prodora vatre i dima',
    'product3-bottom' => 'SMART FIRE MASTIC je pogodan za ugradnju na zidove (blok, cigla, gips), kao i na međuspratne konstrukcije.',

    'product4-title' => 'SMART FIRE PUTTY',
    'product4-introduction-text' => 'SMART FIRE PUTTY je zaptivna masa/git koji ekspandira
na temperaturama iznad 150°C. SMART FIRE PUTTY se koristi za zaštitu od prodiranja vatre oko plastičnih cevi, metalnih cevi (goriva i negoriva izolacija) u kombinaciji sa obujmicama, rešetkama, ciglama, čepovima gde kružni ili bilo koji drugi otvor treba popuniti. Radi se o inovativnoj tehnologiji.',
    'product4-application-text' => 'SMART FIRE PUTTY je zaptivna masa koja zaustavlja prodiranje vatre u zidovima i podovima. Dizajnirana je da se koristi kao zaptivka uz snopove kablova, gorivih i negorivih cevi, u svrhu izolacije i sprečavanja prodora vatre i dima.',
    'product4-bottom' => 'Ova zaptivka je primenjiva na zidane
konstrukcije (blok, cigla), kao i na
međuspratne konstrukcije u zidovima
i podovima, kao i u brzim panelima uz
moguću kombinaciju sa drugim
proizvodima za zaštitu od požara
(obujmica, fleksibilna traka).',

    'product5-title' => 'SMART FIRE GRILL SQUARE',
    'product5-introduction-text' => 'SMART FIRE GRILL (SQUARE) je rešetka napravljena od metalnog profila sa umetcima od polimera dugotrajnih i visokih performansi. Ulošci od materijala na vatrootpornoj bazi u potpunosti popunjavaju preostale otvore kada je rešetka izložena temperaturi iznad 150°C. I na taj način se sprečava prodiranje vatre i dima. Radi se o inovativnoj tehnologiji.',
    'product5-application-text' => 'SMART FIRE GRILL (SQUARE) se ugradjuje u ventilacione otvore pravougaonog oblika u zidovima, u podovima i na vratima.',

    'product6-title' => 'SMART FIRE GRILL ROUND',
    'product6-introduction-text' => 'SMART FIRE GRILL (ROUND) je rešetka napravljena od metalnog profila sa umetcima od polimera dugotrajnih i visokih performansi. Ulošci od materijala na vatrootpornoj bazi u potpunosti popunjavaju preostale otvore kada je rešetka izložena temperaturi iznad 150°C. I na taj način se sprečava prodiranje vatre i dima.
Radi se o inovativnoj tehnologiji.',
    'product6-application-text' => 'SMART FIRE GRILL (ROUND) se ugradjuje u ventilacione otvore okruglog oblika u zidovima, u podovima i na vratima.',
    'product6-bottom' => 'Primenjivo kao deo HVAC sistema unutar okruglih kanala i u zidovima kao samostalne ventilacione rešetke.',
...
Radi se o inovativnoj tehnologiji',
    'product9-application-text' => 'SMART FIRE PLUG se koristi kao zaptivka u zidovima, na podovima i na plafonima. Kroz ovu zaptivku u obliku čepa može penetrirati jedan
kabl ili manji snop kablova na regalu ili samostalnih kablova kao i manje plastične cevi',
    'product9-bottom' => 'Zaptivka se ugradjuje u zidove, a kroz nju mogu penetrirati pojedinačni kablovi, odnosno snopovi istih, kao i plastične cevi.',


    'contact-title' => 'SMARTFIREBLOCK',
    'contact-address' => 'Barička reka, Barič, Beograd, Srbija',
