...
<head>
    ...
    <link rel="icon" href="{{ asset('/assets/images/logohp.png') }}" type="image/x-icon">
    <title>Smart Wire</title>
...
<body>
    ...
    <div class="language-switcher">
        <a href="{{ route('language.switch', 'en') }}"><img src="{{ url('/assets/images/united.png') }}" width="40px"
                alt="united" class="flag"></a>
        <a href="{{ route('language.switch', 'sr') }}"><img src="{{ url('/assets/images/serbia.png') }}" width="40px"
                alt="serbia" class="flag"></a>
    </div>
